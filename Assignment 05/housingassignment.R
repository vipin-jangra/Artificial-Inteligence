...
setwd("C:/Users/dell/Downloads/-PGDDA-and-Data-Analytics-Projects--master/-PGDDA-and-Data-Analytics-Projects--master/Linear Regression - House Price Prediction")
...
#### EDA to find out Patterns based on the target variables

B1 = ggplot(data = housing,aes(x = area,y = price))+geom_point(col="blue")+
  ggtitle("area wise Price distrubution")
print(B1)
...
housing_1 <- cbind(housing[,-13], ummy_1)
View(housing_1)
...
### To identify the House Price Below Variables are important
#area
#bathrooms
#stories
#guestroom
...
#### Please note for this Casestudy we are following the stepwise regression to identify the Sig.. Variable 
#### insted of Doing this We need to use StepAIC will get the same output....
